# Comparing `tmp/datamatic-0.1.4.tar.gz` & `tmp/datamatic-0.1.5.tar.gz`
...
## Comparing `datamatic-0.1.4.tar` & `datamatic-0.1.5.tar`
...
### Comparing `datamatic-0.1.4/LICENSE` & `datamatic-0.1.5/LICENSE`

 * *Files identical despite different names*

### Comparing `datamatic-0.1.4/datamatic/__init__.py` & `datamatic-0.1.5/datamatic/__init__.py`
