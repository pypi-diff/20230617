# Comparing `tmp/webhooklib-0.2.1.tar.gz` & `tmp/webhooklib-0.2.2.tar.gz`
...
## Comparing `webhooklib-0.2.1.tar` & `webhooklib-0.2.2.tar`
...
### Comparing `webhooklib-0.2.1/pyproject.toml` & `webhooklib-0.2.2/pyproject.toml`
...
### Comparing `webhooklib-0.2.1/webhooklib/client.py` & `webhooklib-0.2.2/webhooklib/client.py`
...
### Comparing `webhooklib-0.2.1/webhooklib/models.py` & `webhooklib-0.2.2/webhooklib/models.py`

 * *Files identical despite different names*

### Comparing `webhooklib-0.2.1/webhooklib/process_wrapper.py` & `webhooklib-0.2.2/webhooklib/process_wrapper.py`

 * *Files identical despite different names*

### Comparing `webhooklib-0.2.1/webhooklib/server.py` & `webhooklib-0.2.2/webhooklib/server.py`
